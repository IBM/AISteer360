...
from aisteer360.utils.optional import OPTIONAL_MODULE_EXTRAS
...
def _crawl_methods(root: Path = ROOT, package_prefix: str = "aisteer360.algorithms") -> None:
                ...
                if missing_top_level and missing_top_level != internal_top_level:
                    ...
                    if extra is not None:
                        logger.info(
                            ...
                            '(pip install "aisteer360[%s]" to enable it).',
